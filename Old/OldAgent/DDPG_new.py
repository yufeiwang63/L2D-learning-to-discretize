...
import numpy as np
from Agent.util import SlidingMemory
from Agent.torch_networks import DDPG_actor_network, DDPG_critic_network, NAF_network
...
class DDPG():    
    ...
    def perceive(self, pre_s, action, reward, next_state, if_end):
        self.replay_mem.add([pre_s, action, reward, next_state, if_end])
